           ...
           tabsetPanel(
             ...
             tabPanel(
               ...
               div(class = "tab-content",
                   ...
                   div(class = "section-title", "품질 시각화"),
                   
                   div(class = "description-box",
                       div(class = "description-content",
                           p("결측률이 높은 변수와 이상치 비율이 높은 수치형 변수를 중심으로 품질 문제를 시각적으로 확인합니다."),
                           p("전체 변수별 결측률과 이상치 수는 HTML 보고서의 컬럼별 품질 상세 표에서 확인할 수 있습니다.")
                       )
                   ),
                   
                   fluidRow(
                     column(12,
                            div(class = "section-title", "🔹 결측값 분포 (결측률 상위 변수)"),
                   ...
                   fluidRow(
                     column(12,
                            div(class = "section-title", "🔹 이상치 박스플롯 (이상치 비율 상위 수치형 변수)"),
                            plotOutput("outlier_boxplot", height = "780px")
                     )
                   )
               )
             ),
                     ...
                     column(8,
                            ...
                            div(class = "report-info-box",
                                ...
                                tags$ul(
                                  ...
                                  tags$li("컬럼별 품질 상세 — 변수 유형, 결측률, 고유값 수, 이상치 수"),
                                  tags$li("시각화 — 결측률 상위 변수 막대그래프, 이상치 비율 상위 수치형 변수 박스플롯"),
